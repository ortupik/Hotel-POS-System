...
#include <wx/wx.h>
//(*InternalHeaders(AdminEditDialog)
#include <wx/bitmap.h>
...
//(*IdInit(AdminEditDialog)
const long AdminEditDialog::ID_STATICTEXT6 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT11 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT7 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT12 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT8 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT13 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT9 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT19 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT20 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT17 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT18 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT14 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT10 = wxNewId();
const long AdminEditDialog::ID_STATICBITMAP2 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT5 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT1 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL1 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT4 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL4 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT3 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL3 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT16 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL6 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT15 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL5 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT21 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL7 = wxNewId();
const long AdminEditDialog::ID_STATICTEXT2 = wxNewId();
const long AdminEditDialog::ID_TEXTCTRL2 = wxNewId();
const long AdminEditDialog::ID_BITMAPBUTTON1 = wxNewId();
//*)

BEGIN_EVENT_TABLE(AdminEditDialog,wxDialog)
	//(*EventTable(AdminEditDialog)
	//*)
END_EVENT_TABLE()

AdminEditDialog::AdminEditDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	//(*Initialize(AdminEditDialog)
	...
	Create(parent, wxID_ANY, _("EDIT ADMIN DETAILS"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	StaticBoxSizer1 = new wxStaticBoxSizer(wxHORIZONTAL, this, _("EDIT ADMIN DETAILS"));
	...
	StaticText7 = new wxStaticText(this, ID_STATICTEXT7, _("First Name"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	...
	StaticText8 = new wxStaticText(this, ID_STATICTEXT8, _("Last Name"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	...
	StaticText9 = new wxStaticText(this, ID_STATICTEXT9, _("ID No       "), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	...
	StaticText20 = new wxStaticText(this, ID_STATICTEXT20, _("Phone No  "), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT20"));
	StaticText20->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW));
	BoxSizer16->Add(StaticText20, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	StaticText18 = new wxStaticText(this, ID_STATICTEXT18, _("Phone No  "), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT18"));
	StaticText18->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW));
	BoxSizer15->Add(StaticText18, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	StaticText10 = new wxStaticText(this, ID_STATICTEXT10, _("Phone No  "), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT10"));
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _("Edit Admin Details"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	...
	BoxSizer7->Add(StaticText15, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer7->Add(usernameField, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer18->Add(StaticText21, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer18->Add(passwordField, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer2->Add(BoxSizer18, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer17->Add(StaticText2, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	ConfirmPasswordField = new wxTextCtrl(this, ID_TEXTCTRL2, wxEmptyString, wxDefaultPosition, wxSize(178,21), wxTE_PASSWORD, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	BoxSizer17->Add(ConfirmPasswordField, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer2->Add(BoxSizer17, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	Connect(ID_BITMAPBUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&AdminEditDialog::OnBitmapButton1Click);
	//*)
	  db = new wxSQLite3Database();
      testDBName = wxGetCwd() + wxT("/sales.db");
}
void AdminEditDialog::editUser(wxString firstName,wxString lastName,wxString idNo,wxString phoneNo,wxString username,wxString password){
    db->Open(testDBName);
     wxString buf;
     ...
     switch(dialog.ShowModal()){
       case wxID_YES:
       {
        db->ExecuteUpdate(wxT("UPDATE adminTable SET firstName='"+firstName+"',lastName='"+lastName+"',idNo='"+idNo+"',phoneNo='"+phoneNo+"',username='"+username+"',password='"+password+"' WHERE username='"+username+"'"));
...
{
	//(*Destroy(AdminEditDialog)
	//*)
}


void AdminEditDialog::OnBitmapButton1Click(wxCommandEvent& event)
{
